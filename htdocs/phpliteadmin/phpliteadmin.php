...
//$password = 'admin';
$password = $CFG->phpliteadmin->password;

//directory relative to this file to search for databases (if false, manually list databases in the $databases variable)
//$directory = '.';
//$directory = '../assets/db/';
//$directory = $_SERVER["DOCUMENT_ROOT"] . "/assets/db/";
$directory = $CFG->phpliteadmin->directory;
		...
		case "row_edit":
			...
			for($i=0; $i<sizeof($pks); $i++)
			{
				...
				else
				{
					...
					if($result1===false)
					{
						//echo "<b>Error in fetch ". $db->getError() . '</b>';
						$error = true;
					}
				}
				$completed .= "<span style='font-size:11px;'>".htmlencode($query)."</span><br/>";
